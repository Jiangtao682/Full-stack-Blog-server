...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 4,
      vars: 0,
      consts: [["id", "left", 2, "width", "600px", "float", "left"], ["id", "right", 2, "width", "400px", "float", "left"]],
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, {
        declarations: [_app_component__WEBPACK_IMPORTED_MODULE_3__["AppComponent"], _test_test_component__WEBPACK_IMPORTED_MODULE_5__["TestComponent"], _list_list_component__WEBPACK_IMPORTED_MODULE_6__["ListComponent"], _edit_edit_component__WEBPACK_IMPORTED_MODULE_7__["EditComponent"], _preview_preview_component__WEBPACK_IMPORTED_MODULE_9__["PreviewComponent"]],
        imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_2__["AppRoutingModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpClientModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_8__["FormsModule"]]
      });
    })();
    /*@__PURE__*/
  ...
  function srcAppBlogServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var BlogService = /*#__PURE__*/function () {
      function BlogService(http) {
        ...
        this.posts = [];
        this.draft = new Post();
        var payload = this.parseJWT(document.cookie);
      ...
      _createClass(BlogService, [{
        ...
        value: function fetchPosts(username) {
          ...
          return new Promise(function (resolve, reject) {
            fetch('/api/' + username).then(function (response) {
              return response.json();
            }).then(function (json) {
              _this.posts = [];
              console.log('sucessful fetch!'); // console.log('result:' + json);
              ...
              try {
                for (_iterator.s(); !(_step = _iterator.n()).done;) {
                  ...
                  _this.posts.push(new Post(post));
                }
              } catch (err) {
                _iterator.e(err);
              } finally {
        ...
        value: function getPost(username, postid) {
          return new Promise(function (resolve, reject) {
            fetch('/api/' + username + '/' + postid).then(function (response) {
              return response.json();
            }).then(function (json) {
        ...
        value: function newPost(username, post) {
          ...
          var maxId = Math.max.apply(Math, _toConsumableArray(this.posts.map(function (p) {
            return p.postid;
          })));
          var new_postId = maxId + 1;
        ...
        key: "updataPost",
        value: function updataPost(username, post) {
          var target_index = this.posts.map(function (p) {
            return p.postid;
          }).indexOf(post.postid); // this line may have bug!!

          if (target_index !== -1) {
            // find the target post
            var targetPost = this.posts[target_index];
            ...
            return new Promise(function (resolve, reject) {
              fetch('/api/' + username + '/' + postid, {
                ...
                if (response.status == 204) {
                  // sucess!
                  _this3.posts.splice(target_index, 1);
  ...
  function srcAppEditEditComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function EditComponent_div_2_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function EditComponent_div_2_Template_input_ngModelChange_5_listener($event) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function EditComponent_div_2_Template_textarea_ngModelChange_9_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r2);
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EditComponent_div_2_Template_button_click_15_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r2);
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EditComponent_div_2_Template_button_click_17_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r2);

          var ctx_r5 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r5.updatePost();
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EditComponent_div_2_Template_button_click_19_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r2);
    ...
    var EditComponent = /*#__PURE__*/function () {
      function EditComponent(blogService, activeRouter, router) {
        var _this4 = this;
        ...
        this.activeRouter.paramMap.subscribe(function () {
          return _this4.getCurrentDraft();
        });
      }
      ...
      _createClass(EditComponent, [{
        ...
        value: function getPost() {
          ...
          var promise1 = this.blogService.getPost(this.username, this.id);
        ...
        value: function updatePost() {
          ...
          var promise1 = this.blogService.updataPost(this.username, this.post);
        ...
        value: function deletePost() {
          ...
          this.username = this.blogService.username;
          this.id = parseInt(this.activeRouter.snapshot.paramMap.get('id'), 10);
          var promise1 = this.blogService.deletePost(this.username, this.id);
          promise1.then(function () {
    ...
    EditComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 3,
      vars: 1,
      consts: [["class", "editPane", 4, "ngIf"], [1, "editPane"], ["_ngcontent-c2", "", "novalidate", "", 1, "ng-pristine", "ng-valid", "ng-touched"], ["_ngcontent-c2", ""], ["_ngcontent-c2", "", "formcontrolname", "titleControl", "name", "title", "placeholder", "title", 1, "ng-pristine", "ng-valid", "ng-touched", 3, "ngModel", "ngModelChange"], ["_ngcontent-c2", "", "cols", "50", "formcontrolname", "bodyControl", "name", "body", "placeholder", "", "rows", "10", 1, "ng-pristine", "ng-valid", "ng-touched", 3, "ngModel", "ngModelChange"], ["_ngcontent-c2", "", "type", "button", 3, "click"]],
  ...
  function srcAppListListComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function ListComponent_li_6_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ListComponent_li_6_Template_li_click_0_listener() {
          ...
          return ctx_r2.setCurrentDraft(post_r1);
        });
    ...
    var ListComponent = /*#__PURE__*/function () {
      ...
      _createClass(ListComponent, [{
        ...
        value: function fetchPosts() {
          ...
          this.username = this.blogService.username;
          var promise1 = this.blogService.fetchPosts(this.username);
          promise1.then(function (posts) {
            _this7.posts = posts;
          });
        }
      }, {
        ...
        value: function newPost() {
          ...
          var promise1 = this.blogService.newPost(this.username, null);
          promise1.then(function () {
            console.log('Created a new post!');

            _this8.blogService.setCurrentDraft(_this8.posts[_this8.posts.length - 1]);

            _this8.router.navigate(['/edit/' + _this8.posts[_this8.posts.length - 1].postid]);
          })["catch"](function (error) {
            console.error(error);
          });
        }
    ...
    ListComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 9,
      vars: 2,
      consts: [[3, "click"], [1, "list"], ["routerLinkActive", "active", 3, "routerLink", "click", 4, "ngFor", "ngForOf"], ["routerLinkActive", "active", 3, "routerLink", "click"], [1, "badge"]],
  ...
  function srcAppPreviewPreviewComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var PreviewComponent = /*#__PURE__*/function () {
      function PreviewComponent(blogService, router) {
    ...
    PreviewComponent.ɵfac = function PreviewComponent_Factory(t) {
      return new (t || PreviewComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_blog_service__WEBPACK_IMPORTED_MODULE_2__["BlogService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"]));
    };
  ...
  function srcAppTestTestComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function TestComponent_div_8_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function TestComponent_div_13_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
    ...
    var TestComponent = /*#__PURE__*/function () {
      function TestComponent(blogService) {
        _classCallCheck(this, TestComponent);

        this.blogService = blogService;
        this.updateTtestPost = new _blog_service__WEBPACK_IMPORTED_MODULE_1__["Post"]({
          postid: 6,
          title: 'update',
          body: 'update',
          created: 2,
      ...
      _createClass(TestComponent, [{
        ...
        value: function fetchPosts() {
          ...
          var promise1 = this.blogService.fetchPosts('user2');
          promise1.then(function (posts) {
            _this9.posts = posts;
          });
        } // test for getPost
        ...
        value: function getPost() {
          ...
          var promise1 = this.blogService.getPost('user2', 4);
          promise1.then(function (post) {
            _this10.post = post;
          });
        }
        ...
        key: "newPost",
        value: function newPost() {
          var promise1 = this.blogService.newPost('user2', null);
          promise1.then(function () {
            console.log('Created a new post!');
          })["catch"](function (error) {
            console.error(error);
        ...
        key: "updatePost",
        value: function updatePost() {
          var promise1 = this.blogService.updataPost('user2', this.updateTtestPost);
          promise1.then(function () {
            console.log('Updated a post!');
          })["catch"](function (error) {
            console.error(error);
        ...
        key: "deletePost",
        value: function deletePost() {
          var maxPostid = Math.max.apply(Math, _toConsumableArray(this.posts.map(function (p) {
            return p.postid;
          })));
          var promise1 = this.blogService.deletePost('user2', maxPostid);
          promise1.then(function () {
            console.log('Delete a post!');
          })["catch"](function (error) {
            console.error(error);
    ...
    TestComponent.ɵfac = function TestComponent_Factory(t) {
      return new (t || TestComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_blog_service__WEBPACK_IMPORTED_MODULE_1__["BlogService"]));
    };
    ...
    TestComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 16,
      vars: 2,
      consts: [[3, "click"], [4, "ngFor", "ngForOf"], [4, "ngIf"]],
      template: function TestComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function TestComponent_Template_button_click_2_listener() {
            return ctx.newPost();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function TestComponent_Template_button_click_4_listener() {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function TestComponent_Template_button_click_6_listener() {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function TestComponent_Template_button_click_11_listener() {
            return ctx.getPost();
          });
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /home/cs144/shared/project4/my-blog/src/main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
